...
export default class FirebaseLogin extends Component {
	...
	render() {
		...
		switch(this.state.currentScreen) {
			case 'login':
				screenToShow = <Login change={this.changeScreen} success={this.userSuccessfullyLoggedIn} onLogin={this.props.onAuth}/>;
				break;
			case 'register':
				screenToShow = <Register change={this.changeScreen} onRegister={this.props.onAuth}/>;
				break;
			case 'forgot':
